  ...
  if (!expert) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-gray-500 text-lg">Expert not found</p>
      </div>
    );
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#eaf6f3] via-white to-[#e3f3f7]">
 
      <div className="max-w-7xl mx-auto px-6 py-12">

        <div className="bg-white rounded-[32px] shadow-2xl overflow-hidden">
 
          <div className="p-12 bg-gradient-to-r from-[#8dc4b6] to-[#5faea0] text-white">
            <div className="flex flex-col lg:flex-row gap-10 items-center">
              ...
              <div className="flex-1">
                ...
                <button
                  onClick={() =>
                    expert.available &&
                    navigate(`/booking/${expert.id}`, { state: { expert } })
                  }
                  disabled={!expert.available}
                  className={`mt-6 inline-flex items-center gap-3 px-12 py-4 rounded-full text-lg font-semibold transition
                    ${
                      expert.available
          ...
          <div className="p-12 space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="bg-[#e0f3f2] rounded-2xl p-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {expert.languages.map((lang) => (
                    <span
                      key={lang}
                      className="px-5 py-2 rounded-full bg-white text-[#2f6f64] font-medium shadow"
                    >
                      {lang}
                    </span>
                  ))}
              ...
              <div className="bg-[#e4f1fa] rounded-2xl p-8">
